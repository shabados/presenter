...
const typeComponents = {
  [ 'dropdown' ]: GeneralSettingEvent( Dropdown ),
  [ 'toggle' ]: GeneralSettingParam( Toggle ),
  [ 'slider' ]: GeneralSettingParam( Slider ),
  [ 'urlDropdown' ]: GeneralSettingEvent( UrlDropdown ),
  [ 'textInput' ]: GeneralSettingEvent( TextInput ),
}
